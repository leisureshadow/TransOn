...
public abstract class PlusBaseActivity extends Activity
    ...
    protected static final String TAG = PlusBaseActivity.class.getSimpleName();
            ...
            Plus.AccountApi
                ...
                .setResultCallback(new ResultCallback<Status>() {
                    ...
                    public void onResult(Status status) {
                        Log.v(TAG, "Revoke access successful!");
                        initiateGoogleApiClientDisconnect();
                        updateConnectButtonState();
    ...
    public void onConnectionSuspended(int cause) {
        Log.v(TAG, String.format("Connection suspended (cause: %d).", cause));
        updateConnectButtonState();
        onPlusClientSignOut();
    }
